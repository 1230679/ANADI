...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{identificação-outliers.png}
    \caption{Identificação de Outliers nos Níveis de Ocupação da Rede (PTDs).}
    \label{fig:identificação-outliers}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{capacidade-transformacao.png}
    \caption{Capacidade de Transformação da Rede com a Substituição de Lâmpadas Ineficientes por LED, comparada com a Carga Adicional de VE.}
    \label{fig:capacidade_transformacao}
\end{figure}
